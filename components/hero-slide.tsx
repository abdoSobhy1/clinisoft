        ...
        <CarouselItem className="p-0">
            <div
                ...
                <div className="relative z-5 text-center px-4">
                    ...
                    <MainButton href="#" className="my-4 md:my-10  bg-[#292929] hover:bg-[#292929]/80 w-auto">Explore Features <ArrowRightIcon className="inline-block ml-2 w-4 h-4" /></MainButton>
