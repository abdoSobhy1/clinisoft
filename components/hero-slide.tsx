        ...
        <CarouselItem className="p-0">
            ...
            >
                ...
                <div className="relative z-5 text-center px-4">
                    ...
                    <p className="font-[400] fs-var-sm md:text-[2.17vh] md:leading-8 mt-6 max-w-[95%] md:max-w-3xl m-auto">{description}</p>
                    <DemoButton className="inline-block my-4 md:my-10 py-3 px-8" />
                    <p className="text-[#277A83] text-[2.17vh] font-medium">Trusted by Thousands of clinics across Egypt and the Middle East.</p>
                </div>
            </div>
        </CarouselItem>
    );
