        ...
        <CarouselItem className="p-0">
            ...
            >
                ...
                <div className="relative z-5 text-center px-4">
                    <h1 className="leading-10 md:leading-[96px] text-2xl md:text-5xl lg:text-7xl font-bold relative text-[#A2E2E9] bg-linear-0 from-[#A2E2E9] to-[#FFFFFF] supports-[background-clip:text]:text-transparent supports-[background-clip:text]:bg-clip-text">
                        {title}
                    </h1>
                    <h1 className="absolute px-4 leading-10 md:leading-[96px] inset-0 text-2xl md:text-5xl lg:text-7xl font-bold -z-1 [text-shadow:_0px_4px_4px_rgb(0_0_0_/_0.25)] select-none">
                        {title}
                    </h1>
                    ...
                    <p className="text-[#277A83] text-[20px] font-medium">Trusted by Thousands of clinics across Egypt and the Middle East.</p>
                </div>
            </div>
        </CarouselItem>
    );
