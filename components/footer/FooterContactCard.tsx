...
const FooterContactCard: React.FC = () => (
    <div className="bg-[#FFFFFF0D] rounded-[20px] px-2 py-6 w-full max-w-xs mx-auto col-span-2 md:col-span-1">
        <div className="flex items-center justify-center gap-3">
            <Image src="/icons/support.svg" alt="Support Icon" width={40} height={50} />
            <div className="text-[#00040d] text-xs font-semibold">
        ...
        <a href="http://wa.me/+201208123222" className="bg-[#FFFFFF14] rounded-2xl p-4 flex items-center justify-center gap-2 text-white text-base font-bold w-fit mx-auto" >Contact Us <Image src="/icons/whatsapp.svg" alt="Whatsapp Icon" width={20} height={20} /></a>
    </div>
);
