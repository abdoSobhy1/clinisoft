...
const FooterContactCard: React.FC = () => (
    <div className="bg-[#FFFFFF0D] rounded-[20px] px-2 py-6 w-full max-w-xs mx-auto col-span-2 md:col-span-1">
        ...
        <a href="http://wa.me/+201208123222" className="bg-[#FFFFFF14] rounded-2xl p-4 flex items-center justify-center gap-2 text-white text-base font-bold w-fit mx-auto" >Contact Us <Image src="/images/icons/whatsapp.svg" alt="Whatsapp Icon" width={20} height={20} /></a>
    </div>
);
